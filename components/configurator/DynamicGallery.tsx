...
const FALLBACK_IMAGES: GalleryImage[] = [
    { _id: 'f1', imageUrl: '/images/zdjecia-safe/topo_shelf_dab.jpg', title: 'Realizacja Topo Shelf' },
    { _id: 'f2', imageUrl: '/images/zdjecia-safe/contour_panel_jesion.png', title: 'Panel Contour' },
    { _id: 'f3', imageUrl: '/images/zdjecia-safe/modu_block_dab.jpg', title: 'Modu Block Dąb' },
    { _id: 'f4', imageUrl: '/images/zdjecia-safe/wall_panel_system.jpg', title: 'Wall Panel System' },
];
    ...
    return (
        <div className="p-6 h-full flex flex-col bg-white border-l border-gray-100">
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
                <p className="text-[11px] text-gray-dark text-center uppercase tracking-wider">
