    ...
    return (
        <div className="w-full h-full relative bg-[#f5f5f5]">
            ...
            <div className="absolute top-6 left-6 pointer-events-none">
                <span className="text-[11px] uppercase font-bold tracking-widest text-primary-black/50 bg-white/80 px-3 py-1.5 rounded-full backdrop-blur-sm border border-white">
                    Podgląd 3D
                </span>
            </div>
        </div>
