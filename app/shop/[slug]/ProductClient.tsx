  ...
  return (
    <div className="min-h-screen bg-primary-white">
      ...
      <div className="pt-32 pb-32 container-premium">
        ...
        <Link
          href={
            collectionParam ? `/shop?collection=${collectionParam}` : "/shop"
          }
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-10">
            ...
            <div className="border-b border-gray-200 pb-8">
              <h1 className="text-4xl font-serif text-primary-black mb-2">
                {product.name}
              </h1>
              <div className="flex items-baseline gap-4">
                <span className="text-2xl font-light">
                  {activeVariant.price} PLN
                </span>
            ...
            <div className="space-y-4">
              <label className="text-xs uppercase tracking-[0.2em] text-gray-900 font-semibold block">
                Wybierz Drewno
              </label>
              <div className="flex gap-4">
                {product.variants.map((variant: ProductVariant) => {
                  const variantInfo =
                    WOOD_VARIANTS[variant.woodType as ShopWoodType];
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Tooltip */}
                      <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[11px] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity bg-black text-white px-2 py-1 rounded-sm pointer-events-none">
                        {variant.name}
                      </span>
                    </button>
                  );
