      ...
      <div className="relative pt-12 pb-32">
        ...
        <div className="container-premium grid md:grid-cols-2 gap-16 lg:gap-24 items-start relative z-10">
          <div className="space-y-10">
            <div>
              <span className="text-sm tracking-[0.2em] text-[#C4A484] uppercase mb-4 block">
                Porozmawiajmy
              </span>
              <h1 className="text-5xl font-light mb-8 font-serif">Kontakt</h1>
              <p className="text-gray-dark text-lg leading-relaxed">
                Jesteśmy tu, aby pomóc Ci zrealizować Twój projekt. Napisz do
                nas, zadzwoń lub odwiedź naszą pracownię.
              </p>
            </div>
            ...
            <div className="space-y-8 py-8 border-t border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="uppercase tracking-wider text-xs font-bold mb-1">
                    Email
                  </h3>
                  <p className="text-xl font-serif">kontakt@auralasu.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-[#C4A484]">
          ...
          <div className="bg-gray-50 p-10 rounded-sm md:sticky md:top-32">
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-xs uppercase tracking-wider mb-2 text-gray-500">
                  Imię i Nazwisko
                </label>
                <input
                  type="text"
