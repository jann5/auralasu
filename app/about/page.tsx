                ...
                <div className="grid md:grid-cols-12 gap-12 lg:gap-24">
                    ...
                    <div className="md:col-span-7 space-y-10">
                        <div>
                            ...
                            <h1 className="text-5xl font-light mb-8 font-serif leading-tight">O Pracowni <br />AuraLasu</h1>
                            <div className="w-16 h-[2px] bg-primary-black mb-8"></div>
                        </div>

                        <div className="prose prose-lg text-gray-dark font-light leading-relaxed">
                            <p>
                                <strong className="font-serif text-primary-black text-xl">AuraLasu</strong> to miejsce, gdzie tradycyjne rzemiosło spotyka się z nowoczesnym designem.
                    ...
                    <div className="md:col-span-5 relative">
                        <div className="sticky top-32 space-y-8">
                            ...
                            <div className="bg-[#FAF9F6] p-8 border-l-2 border-[#C4A484]">
                                ...
                                <p className="text-sm font-bold mt-4 text-[#C4A484] uppercase tracking-widest">— Założyciel</p>
                            </div>
                        </div>
                    </div>
                </div>
