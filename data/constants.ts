...
export const WOODS: WoodInfo[] = [
    {
        ...
        code: 'DABN',
        color: '#D4A574',
        textureUrl: '/images/zdjecia-safe/dab_naturalny_mask.jpg',
        multiplier: 1.0
    },
    {
        id: 'dab_wedzony',
        ...
        code: 'DABW',
        color: '#8B5A2B',
        textureUrl: '/images/zdjecia-safe/dab_wedzony_mask.jpg',
        multiplier: 1.15
    },
    {
        id: 'jesion_jasny',
        ...
        code: 'JESJ',
        color: '#C4B5A0',
        textureUrl: '/images/zdjecia-safe/jesion_jasny_mask.jpg',
        multiplier: 1.1
    },
    {
        id: 'jesion_smolowany',
        ...
        code: 'JESS',
        color: '#6B5D52',
        textureUrl: '/images/zdjecia-safe/jesion_smolowany_mask.webp',
        multiplier: 1.2
    }
];
